        ...
        <div id="sticky_side_nav_inner">
            <ul class="nav navbar-nav">
                <li><a href="index.php"><span class="glyphicon glyphicon-home hidden-xs"></span> <span class="home visible-xs">Home</span></a></li>
                 ...
                 <li class="dropdown">
                    <a href="#" class="fa fa-group">Behind Us</a>
                ...
                <li class="dropdown">
                  <?php if(isset($_SESSION['username'])){ ?>
                    <a href="../eng/pages/home.php" class="fa fa-comments-o">Discussion Form</a>
                ...
                <li class="dropdown">
                 ...
                 <?php if(isset($_SESSION['username'])) //echo $_SESSION['username']; ?> <a href="../eng/pages/logout.php" class="fa fa-user">Logout</a></li>
                                    <li>
